document.addEventListener("DOMContentLoaded", ()=>{
    gsap.registerPlugin(ScrollTrigger), gsap.registerPlugin(SplitText), document.fonts.ready.then(()=>{
        gsap.set("#headline-content", {
            opacity: 1
        });
        let r = SplitText.create("#headline", {
            type: "words",
            aria: "hidden"
        });
        gsap.from(r.words, {
        ...
        ScrollTrigger.getAll().forEach((r)=>r.kill()), gsap.globalTimeLine.clear();
    });
});

//# sourceMappingURL=agency-landing-page.47d3ba2b.js.map
